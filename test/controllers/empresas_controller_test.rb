...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { direccion: @empresa.direccion, email: @empresa.email, name: @empresa.name, phone: @empresa.phone, user_id: @empresa.user_id, web: @empresa.web } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { direccion: @empresa.direccion, email: @empresa.email, name: @empresa.name, phone: @empresa.phone, user_id: @empresa.user_id, web: @empresa.web } }
